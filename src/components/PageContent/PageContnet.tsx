    ...
    <div className={colSize}>
      ...
      {pageComponents.map((component: any) => {
        if (component.component_type === "body") {
          const componentBody = component.body.replaceAll(
            "/uploads",
            ...
            return (
              ...
              >
                <div className={twoColImageStyles["wrapper"]}>
                  <div
                    className={cn(
                      twoColImageStyles["content"],
                      twoColImageStyles["right-image"]
                    )}
                  ...
                  <div className={panoramsStyles["items"]}>
                    {component.panoramas.data.map((el) => (
                      <a
                        ...
                        onClick={() =>
                          handleOpenFullScreenFrame(el.attributes.link)
                        }
                      >
                        <img
          ...
          return (
            ...
            >
              <Accordion
                ...
                defaultOpen={component.default_open}
              >
          ...
          const personLink = component.worker.data.attributes.cycle_commission
            .data
          ...
          return (
            <div className={personStyles["wrapper"]}>
              ...
              <Link href={personLink} target="_blank">
                <h5 className={personStyles["name"]}>
                  {component.worker.data.attributes.name}
                </h5>
              </Link>

              <p className={personStyles["position"]}>
                {component.worker.data.attributes.position}
              </p>
              {component.worker.data.attributes.phone && (
                <div>
                  <a
                    className={personStyles["tel"]}
                    href={`tel:${phoneWithoutSymbols}`}
                  >
                    {component.worker.data.attributes.phone}
                  </a>
                </div>
              ...
              <div>
                <a
                  className={personStyles["email"]}
                  href={`mailto:${component.worker.data.attributes.email}`}
                >
            ...
            <div className="container">
              <div className={styles["full-size__wrapper"]}>
                ...
                <div className={styles["full-size__content"]}>
                  <h3 className={styles["full-size__title"]}>
                    {component.name}
                  </h3>
                  <div
                    className={styles["full-size__text"]}
                    dangerouslySetInnerHTML={{ __html: componentBody }}
                  />
                </div>
              </div>
          ...
          const componentBody = component.description.replaceAll(
            "/uploads",
            `${process.env.API_URL}/uploads`
          )
          const accordionBody = component.authors.body.replaceAll(
            "/uploads",
            `${process.env.API_URL}/uploads`
          )
