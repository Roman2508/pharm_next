...
export type GetNewsQueryVariables = Exact<{
  reqItemsCount?: InputMaybe<Scalars['Int']['input']>;
}>;
...
export const GetNewsDocument = gql`
    query GetNews($reqItemsCount: Int = 3) {
  novinas(sort: "date:desc", pagination: {limit: $reqItemsCount}) {
    data {
      id
      attributes {
        title
